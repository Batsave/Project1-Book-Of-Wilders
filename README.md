...
### 🎖️Achievements :
- **PWA:** Our website complies with the PWA standard and is therefore accessible offline and pinnable on your devices for faster access.
...
- **Speed:** Our site sets speed records with a 100% on the LightHouse PC test and 98% on Mobile. Improvements are underway to optimize this latter result.
